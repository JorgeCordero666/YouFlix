...
function crearTarjetas(movies) {
  // Creación de elementos HTML y asignación de datos de películas a los elementos
  ...
  movies.forEach((movie) => {
    ...
    // Se adjuntan los elementos creados al contenedor en la página.
...
addMovieButton.addEventListener("click", () => {
  // Creación del modal y formulario para agregar una nueva película
  // Manejo del envío del formulario para crear una nueva película
  const modal = document.getElementById("myModal");
  const modalContent = document.getElementById("modal-content");
